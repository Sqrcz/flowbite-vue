...
const fileInputButtonDefaultClasses = 'hover:file:bg-gray-100 dark:hover:file:bg-gray-600 dark:file:bg-gray-700 file:bg-gray-200 hover:file:border-gray-300 dark:hover:file:border-gray-500 dark:file:border-gray-600 file:border-0 file:border-gray-300 file:border-r file:rounded-none dark:file:text-gray-400 file:text-gray-900 file:cursor-pointer'
